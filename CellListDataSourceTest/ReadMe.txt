========================================================================
    コンソール アプリケーション: CellListDataSourceTest プロジェクトの概要
========================================================================

この CellListDataSourceTest アプリケーションは、AppWizard により作成されました。

このファイルには、CellListDataSourceTest 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


CellListDataSourceTest.vcxproj
...
CellListDataSourceTest.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、CellListDataSourceTest.pch 
