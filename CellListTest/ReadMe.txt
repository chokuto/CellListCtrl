================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: CellListTest プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した CellListTest には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには CellListTest アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

CellListTest.vcxproj
...
CellListTest.h
   ...
   CCellListTestApp アプリケーション クラスを宣言します。

CellListTest.cpp
   これは、アプリケーション クラス CCellListTestApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\CellListTest.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル CellListTest.rc に含まれていま
   す。

res\CellListTest.rc2
...
CellListTestDlg.h, CellListTestDlg.cpp - ダイアログ
   これらのファイルは CCellListTestDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な CellListTest.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   CellListTest.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
